...
**一句话**：3 个 STM32F103VET6 节点（采集温湿度 / 三轴姿态 / 模拟量），通过 NRF24L01+ 2.4 GHz 接入 ESP32-S3 网关，网关经 Wi-Fi/MQTT 上报到 OneNet，Web 端可见实时数据。
...
| 项 | 内容 |
|---|---|
| **目标** | DHT11 / MPU6050 / NRF24L01+ 三类外设各自驱动跑通，**独立任务验证** |
